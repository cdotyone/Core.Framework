...
namespace Civic.Framework.WebApi.Test.Business
{
    ...
    public partial class Entity3Facade : IEntityBusinessFacade<IExampleEntity3>
    {
            private readonly IEntityRepository<IExampleEntity3> _repository;
            private readonly IEntityEventHandlerFactory _handlers;
    		private readonly IEntityCreateFactory _factory;
    
            public Entity3Facade(IEntityRepository<IExampleEntity3> repository, IEntityCreateFactory factory, IEntityEventHandlerFactory handlers)
            {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity3Facade), "Get")) {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity3Facade), "GetPaged")) {
        	...
        	public void Save(IEntityRequestContext context, IExampleEntity3 entity) 
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity3Facade), "Save")) {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity3Facade), "Remove")) {
                    var first = context.Operations.Count == 0;
            ...
            public IEnumerable<IExampleEntity3> GetPaged(ClaimsPrincipal who, IEntityInfo info, int skip, ref int count, bool retCount, string filterBy, string orderBy)
            {
                return GetPaged(new EntityRequestContext { Who = who }, info, skip, ref count, retCount, filterBy, orderBy);
            }
        
        	public IExampleEntity3 Get(ClaimsPrincipal who, IExampleEntity3 entity) {
        		return Get(new EntityRequestContext {Who = who}, entity);
        	}
        
        	public void Save(ClaimsPrincipal who, IExampleEntity3 entity) {
        		Save(new EntityRequestContext {Who = who}, entity);
        	}
        
        	public void Remove(ClaimsPrincipal who, IExampleEntity3 entity ) {
