...
namespace Civic.Framework.WebApi.Test.Business
{
    ...
    public partial class Entity2Facade : IEntityBusinessFacade<IExampleEntity2>
    {
            private readonly IEntityRepository<IExampleEntity2> _repository;
            private readonly IEntityEventHandlerFactory _handlers;
    		private readonly IEntityCreateFactory _factory;
    
            public Entity2Facade(IEntityRepository<IExampleEntity2> repository, IEntityCreateFactory factory, IEntityEventHandlerFactory handlers)
            {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity2Facade), "Get")) {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity2Facade), "GetPaged")) {
        	...
        	public void Save(IEntityRequestContext context, IExampleEntity2 entity) 
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity2Facade), "Save")) {
        	...
        	{
                using(Logger.CreateTrace(LoggingBoundaries.ServiceBoundary, typeof(Entity2Facade), "Remove")) {
                    var first = context.Operations.Count == 0;
            ...
            public IEnumerable<IExampleEntity2> GetPaged(ClaimsPrincipal who, IEntityInfo info, int skip, ref int count, bool retCount, string filterBy, string orderBy)
            {
                return GetPaged(new EntityRequestContext { Who = who }, info, skip, ref count, retCount, filterBy, orderBy);
            }
        
        	public IExampleEntity2 Get(ClaimsPrincipal who, IExampleEntity2 entity) {
        		return Get(new EntityRequestContext {Who = who}, entity);
        	}
        
        	public void Save(ClaimsPrincipal who, IExampleEntity2 entity) {
        		Save(new EntityRequestContext {Who = who}, entity);
        	}
        
        	public void Remove(ClaimsPrincipal who, IExampleEntity2 entity ) {
