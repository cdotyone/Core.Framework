...
namespace Civic.T4.Data
{
    internal partial class ExampleData
    {
        ...
        internal static List<EnvironmentEntity> GetPagedEnvironment(int skip, ref int count, bool retCount, string filterBy, string orderBy, string[] fillProperties = null)
        {
        ...
        private static bool populateEnvironment(EnvironmentEntity environment, IDataReader dataReader, string[] fillProperties = null)
        {
